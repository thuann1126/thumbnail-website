    ...
    <>
      <div>
        ...
        <div className="menuContent">
          <div className="serviceTitle">PRICES VARY BY STYLIST</div>
          <div className="serviceTitle">MANICURES</div>
          <div className="itemList">{printManicuresPrice}</div>
          <div className="serviceTitle">NAIL EXTENSION</div>
          <div className="itemList">{printNail_extensions_Price}</div>
          <div className="serviceTitle">PEDICURES</div>
          <div className="itemList">{printPedicuresPrice}</div>
          <div className="serviceTitle">ADD ONS</div>
